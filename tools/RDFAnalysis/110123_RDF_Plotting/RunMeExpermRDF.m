...
%======================================================================
clear all
NormalizeTheIntensity = 'No';
ImFolder = 'I:\AY-Data2\101102S10E\Stitched\C06\ROI\';
...
RDFs = cell2mat(RDFs);
if strcmp('Yes', NormalizeTheIntensity)
    RDFs = RDFs - min(RDFs(:));
end    
% How many points to skip while plotting, 1 - plot every point
PlotingStep = 1;
PlotTimePoints = [1, 16, 31, 46];
